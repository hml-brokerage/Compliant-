...
export class CreateProgramDto {
  ...
  @ApiPropertyOptional({ description: 'Whether this is a template', default: true })
  @IsBoolean()
  @IsOptional()
  isTemplate?: boolean;
  ...
  @ApiPropertyOptional({ description: 'Requires Hold Harmless agreement', default: false })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Requires Waiver of Subrogation', default: true })
  @IsBoolean()
  @IsOptional()
  requiresWaiverSubrogation?: boolean;

  @ApiPropertyOptional({ description: 'Tier-based requirements', type: 'object' })
  @IsObject()
  @IsOptional()
  tierRequirements?: Record<string, any>;

  @ApiPropertyOptional({ description: 'Trade-specific requirements', type: 'object' })
  @IsObject()
  @IsOptional()
